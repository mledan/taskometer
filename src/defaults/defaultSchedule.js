...
export const DEFAULT_WHEELS = [
  {
    ...
    blocks: [
      ...
      { startTime: '06:30', endTime: '07:15', slotType: 'food',             label: 'Breakfast',      color: '#A8BF8C' },
      { startTime: '07:15', endTime: '08:00', slotType: 'health',           label: 'Workout',        color: '#10B981' },
      ...
      { startTime: '22:00', endTime: '00:00', slotType: 'downtime',         label: 'Wind Down',      color: '#78716C' },
    ],
  },
  {
    id: 'starter_weekend',
